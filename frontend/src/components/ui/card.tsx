...
function CardTitle({ className, ...props }: React.ComponentProps<"h3">) {
  // Rendered as a real heading (not a div) so screen readers get a correct
  // document outline — nearly every screen in this app uses Card, so this
  // is load-bearing for the spec's accessibility requirement, not cosmetic.
  return (
    <h3
