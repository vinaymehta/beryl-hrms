    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          // Plain (non-data-attribute-scoped) defaults so a consumer's own
          // w-*/max-w-* in `className` can override them normally — the
          // previous data-[side=...]-scoped width/max-width had higher CSS
          // specificity than any plain override, so per-usage sizing (e.g.
          // wider recruitment/employee/mail panels) was silently clamped
          // back down to max-w-sm regardless of what was passed in.
